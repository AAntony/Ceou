...
- Configuration encore manquante signalée le 17 septembre : message « Réglementations européennes » non publié. Les demandes du compte de test sont bien préparées puis annulées avant toute annonce, sans récompense accordée. Publier le message pour l'application Android Céoù (français, anglais, options de refus et de gestion, lien vers les règles de confidentialité), puis retester sur téléphone. La cause native exacte des anciennes tentatives n'était pas journalisée.
